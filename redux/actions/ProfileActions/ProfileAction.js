...
const fetchProfile = (obj, dispatch) => {
  axios({
    method: "GET",
    url: `http://127.0.0.1:8000/api/api/v1/profile-viewset/?username=${obj.user}`,
    headers: {
    ...
    .then((res) => {
      if (res) {
        axios({
          method: "GET",
          url: `http://127.0.0.1:8000/api/api/v1/all-collection-get-for-profile/`,
          headers: {
            Authorization: `Token ${localStorage.getItem("__vig__mod_1")}`,
          },
        })
  ...
  axios({
    ...
    .then((res) => {
      if (res) {
        axios({
          method: "GET",
          url: `http://127.0.0.1:8000/api/api/v1/draft-collection-get-for-profile/`,
          headers: {
            Authorization: `Token ${localStorage.getItem("__vig__mod_1")}`,
          },
        })
  ...
  axios({
    ...
    .then((res) => {
      if (res) {
        axios({
          method: "GET",
          url: `http://127.0.0.1:8000/api/api/v1/published-collection-get-for-profile/`,
          headers: {
            Authorization: `Token ${localStorage.getItem("__vig__mod_1")}`,
          },
        })
...
export const postProfileChangeAction = (obj) => (dispatch) => {
  ...
  axios({
    method: "PATCH",
    url: `http://127.0.0.1:8000/api/api/v1/profile-viewset/${obj.id}/`,
    data: formData,
    headers: {
      Authorization: `Token ${localStorage.getItem("__vig__mod_1")}`,
...
export const getPublicProfileActions = (obj) => (dispatch) => {
  ...
  axios({
    method: "GET",
    url: `http://127.0.0.1:8000/api/api/v1/public-author_getby-username/?username=${obj.user}`,
  })
    .then((res) => {
      if (res) {
        axios({
          method: "GET",
          url: `http://127.0.0.1:8000/api/api/v1/published-collection-get-for-public-author/?author_id=${res.data.results[0].user_id}`,
        })
          .then((data) => {
            dispatch(
