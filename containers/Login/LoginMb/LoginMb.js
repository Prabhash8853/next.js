...
import { updateObject } from "../../../redux/ReduxUtility/ReduxUitility";
...
import Logo from "../../../public/img/vigyaa-logo-home.svg";
  ...
  constructor(props) {
    ...
    this.state = {
      ...
      URLtoCheck:
        ...
        window.location.href.indexOf("/login/?next="),
      redirectionURL: "",
      Form: {
        email: {
          elementType: "input",
                ...
                <React.Fragment>
                  <div className="login_sec_mb">
                    <div className="login_logo text-center">
                      <a href="/">
                        <img src={Logo} alt="vigyaa-logo"></img>{" "}
                      </a>
                    </div>
                  ...
                  <div className="signup_sec_mb">
                    <p className="text-center">
                      {" "}
                      <Link href="/create-account">Or Sign up</Link>
                    </p>
                  </div>
                </React.Fragment>
              }
            ...
            <React.Fragment>
              {this.props.isAuthenticate ? (
                ...
                this.state.URLtoCheck === -1 ? (
                  ...
                  Router.push(this.state.redirectionURL)
                )
              ) : (
                <React.Fragment>
                  <div className="login_sec_mb">
